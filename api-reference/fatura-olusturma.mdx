...
<Warning>
  `POST /v1/invoices` **resmî mali belge üretir.** Denemelerinizi önce `POST /v1/invoices/preview` (yan etkisiz) ve `isDraft: true` (taslak) ile yapın. Faturanın API üzerinden iptali bu sürümde yoktur; iptal işlemleri panelden yürütülür.
</Warning>
